$(function(){
    ...
    $(".inner").css({
        ...
        // 보여질 박스의 너비 * 아이템 개수
        marginLeft : - carWidth
        // 마지막번째 요소가 끼어들어 순서가 밀리기 때문에 한칸만큼 앞으로 당겨줌
    ...
    function prevReady() {
        ...
        // 첫번째 column에서 이전 버튼을 누를 경우에도 이어질 수 있도록 마지막 칼럼을 첫번째에 끼워넣어 준비해둔다.

    }

    prevReady();
    // 처음에 페이지에 접근했을 때 1번 column이 보여지는 상태에서도 이전 버튼을 클릭했을 때 이어지게끔 준비해둠.
